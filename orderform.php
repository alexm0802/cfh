...
<div id="container">
    ...
    <div class="maincontent">    	
		...
		<p>
			...
			email us at cfh-exec@mit.edu or leave a note in the comments and we will try to work something out. 
		</p>
...
?>
				...
				<p>
					If you do not pay or contact us about payment by <b>11:59 pm on  Wednesday</b>, 
						your order will be cancelled. <br><br> 
						
					5 hours of volunteering earns you a free challah! <br><br>
				...
				<p>
					...
					<select name = "location">
                        <option value="Not selected" selected> Please Select a Location </option>
						...
						<!-- <option value="Senior Haus">Senior Haus </option>     -->
                        <option value="SigEp">SigEp </option>
						<option value="Simmons">Simmons </option> 
						<!-- <option value="Sidney Pacific"> Sidney Pacific </option> 
						<option value="Tang"> Tang </option>  -->
						<!-- <option value="Whitehead Institute">Whitehead Institute (Friday Morning) </option>
				...
				<p>
					...
					Dough making runs from 5:00 pm - 6:30 pm. Baking starts at 7:00 pm. You can arrive whenever and stay as long as you like. <br>
					<input type="radio" name="volunteer" value="Yes - dough making">Yes - dough making <br>
	...
	?>
			<p>We have sold out of challah! 
		 	Feel free to submit an order to the 
			<a href="https://docs.google.com/forms/d/1dcLoeKE7cayuHZ0CV4a4KTe5MMn-VRJGNuUKdmsyX90/viewform">wait 
			list</a>. If we have extra challah, you might get one!  
			</p>
	<?php 			
		}
        	}
